...
**Note for customers using Azure Lighthouse+Azure AD PIM:**  *All Azure Lighthouse+Azure AD PIM functionality is currently in **private preview**. If you are a customer onboarding your scopes to Azure Lighthouse for management and your service provider is using Azure AD PIM functionality, you may see a governance API error message if your subscription is not whitelisted for Azure Lighthouse+PIM preview. Simply request to whitelist the subscription your are trying to delegate for the preview to resolve this error*
